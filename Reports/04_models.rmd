...
d = d[,c("diff_head", "condition","attract", "dist2cent", "align", "cross.wind" , "turn2home", "pigeon", "unique.flight", "group.num", "small.big")]
...
# SUBSET DATA
d = dat[sam9,]
d = d[,c("diff_head_sharp","condition","attract", "dist2cent", "align", "cross.wind" , "turn2home", "pigeon", "unique.flight", "group.num", "small.big")]
d = d[complete.cases(d),]
...
# SUBSET DATA
d.coh = dat.coh[sam9,]
d.coh = d.coh[,names(d.coh) %in% c("diff_head_sharp","condition","attract", "dist2cent", "align", "cross.wind" , "turn2home", "pigeon", "unique.flight", "group.num", "small.big")]
...
d = dat[sam9,]
d = d[,c("turn2falchead" , "turn2falcpos", "diff_head_sharp","attract", "dist2cent", "align", "cross.wind" , "turn2home", "pigeon", "unique.flight", "group.num", "small.big")]
d = d[complete.cases(d),]
...
d.con = dat.con[sam,c("biased.cent","dist2pred","small.big","pigeon","unique.flight", "group.num")]
