...
for ( i in 9:length(files)){
  ...
  group.size = c(group.size ,rep(flock.size,g.size))
  
  # print
  print(i)
}
insta.grp.size = group.size
save( insta.grp.size, file= file.path(PROJHOME , "smaller-dataframes-for-git", "insta-grp-size.rda"))
```
